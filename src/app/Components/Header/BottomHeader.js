      ...
      <div className="md:max-10 lg:mx-20 hidden lg:flex lg:flex-row lg:justify-between lg:items-center py-4 font-semibold text-lg ">
        <ul className="flex flex-row justify-center items-center gap-5  ">
          ...
          {scrolled ? (
            ...
            <a className='hover:text-[#7BB761] hover:underline' href="/category/पर्वतारोहण">पर्वतारोहण</a>
          </li>
          <li className="nav-item">
            <a className='hover:text-[#7BB761] hover:underline' href="/category/पदयात्रा">पदयात्रा</a>
          </li>
          <li
  className="relative"
    ...
    {dropdown1Visible && (
      <ul className="flex flex-col justify-start items-start gap-2" onMouseLeave={() => setDropdown1Visible(false)}>
        ...
        <li><a className='hover:text-[#7BB761] hover:underline' href="/category/हस्पिटालिटी">हस्पिटालिटी</a></li>
          ...
          <li className="nav-item">
            <a className='hover:text-[#7BB761] hover:underline' href="/category/पुरातत्व">पुरातत्व</a>
          </li>
          ...
          <li className="nav-item">
            <a className='hover:text-[#7BB761] hover:underline' href="/category/बिशेष">बिशेष</a>
          </li>
          <li className="nav-item">
            <a className='hover:text-[#7BB761] hover:underline' href="/category/अन्तरवार्ता">अन्तरवार्ता</a>
          </li>
          <li
            className="relative"
          ...
          >
            ...
            {dropdown2Visible && (
                ...
                <li><a className='hover:text-[#7BB761] hover:underline' href="/category/खेलकुद">खेलकुद</a></li>
