...
const ARTICLES_API = `${API_URL}/api/articles/category/अन्तर्राष्ट्रिय/status/published`;
          ...
          {article.authorName && (
            <div className="flex items-center">
              ...
              <span
                ...
                onClick={() =>
                  article.authorId && onAuthorClick(article.authorId)
                }
              >
                {article.authorName}
              </span>
    ...
    <div className="mx-3 md:mx-9 lg:mx-18">
      {loading ? (
        ...
        <>
          ...
          <AdvertisementComponent position="nepali_aboveinternational" />
          <div className="my-2">
          ...
          <AdvertisementComponent position="nepali_belowinternational" />
        </>
      )}
    </div>
  );
