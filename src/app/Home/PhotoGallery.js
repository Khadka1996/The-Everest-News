    ...
    <div className="mx-3 md:mx-10 lg:mx-18">
      {loading ? (
        ...
        <>
          ...
          <AdvertisementComponent position="nepali_abovephotogallery" />
          <div className="my-2">
            <h1
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {articles.map((article) => (
              <div
                key={article._id}
                className="relative bg-black text-white rounded-lg overflow-hidden cursor-pointer"
                ...
                {article.articlePhoto ? (
                  <>
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center cursor-pointer">
                      <h2 className="text-xl font-semibold absolute bottom-2 left-2 z-10 hover:text-[#25609A]">
                        {article.headline}
                      </h2>
          ...
          <AdvertisementComponent position="nepali_belowphotogallery" />
        </>
      )}
    </div>
  );
