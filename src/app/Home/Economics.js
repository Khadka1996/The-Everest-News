...
const ARTICLES_API = 'https://api.theeverestnews.com/api/articles/category/अर्थतन्त्र';
        ...
        <div className="flex-1">
          {loading ? (
            ...
            <>
              ...
              <div className="my-2">
                <h1
                  className="text-xl md:text-2xl font-extrabold text-white bg-[#25609A] py-2 px-4 md:px-6 rounded-t-lg shadow-lg cursor-pointer hover:bg-[#7BB660] transition-all duration-300 ease-in-out"
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-gray-600 text-xs md:text-sm mb-2">
                        ...
                        <button
                          ...
                          className="flex items-center text-[#25609A] hover:underline"
                        >
                          {article.authorPhoto && (
                            <img
