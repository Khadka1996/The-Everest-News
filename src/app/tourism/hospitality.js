    ...
    const fetchData = async () => {
      try {
        ...
        const [articlesResponse, authorsResponse] = await Promise.all([
          axios.get(`${API_URL}/api/articles/category/हस्पिटालिटी/status/published`, { params: { page: DEFAULT_PAGE, limit: ARTICLES_LIMIT } }),
  ...
  return (
    ...
    <div className="mx-3 md:mx-10 lg:mx-20 mt-5">
      ...
      {(articles.length > 0 || loading) && (
        <h1 className="text-3xl font-semibold mb-4 text-[#7BB660]">हस्पिटालिटी</h1>
      )}
