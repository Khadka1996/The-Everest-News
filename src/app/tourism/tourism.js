        ...
        const fetchData = async () => {
            try {
                ...
                const [articlesResponse, authorsResponse] = await Promise.all([
                    axios.get(`${API_URL}/api/articles/category/पर्यटन/status/published`, { params: { page: DEFAULT_PAGE, limit: ARTICLES_LIMIT } }),
                ...
                if (data.length > 0) {
                    data.sort((a, b) => a.headline.localeCompare(b.headline));
                    setArticles(data);
